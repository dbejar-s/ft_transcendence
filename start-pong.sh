...
echo ""
echo "⚠️  IMPORTANT: You must manually accept SSL certificates!"
echo "📋 Required steps:"
echo "   1. Open https://localhost:3001 and accept the certificate warning"
echo "   2. Open https://localhost:5173 and accept the certificate warning"
echo "   3. Your application will then work normally"
echo ""
echo "💡 Why: Browsers require manual acceptance of self-signed certificates"
echo "   The SSL automation above helps warm the connections, but cannot"
echo "   bypass browser security policies for certificate acceptance."
echo ""
echo "🚀 After accepting certificates, your app will work perfectly!"
